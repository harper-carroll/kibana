...
perl scripts/buildDpiMsgLRProto.pl resources/Qosmos_Protobook.csv protofiles/DpiMsgLRproto.proto.orig resources/ProtocolFilters resources/LuaProtoFieldDesc.csv resources/remapping cpp/source/liblrdpi/remapping.ipp resources/NetMonFieldNames.csv $TMPFILE2
