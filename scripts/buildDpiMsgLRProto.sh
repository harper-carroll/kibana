...
perl scripts/buildDpiMsgLRProto.pl resources/Qosmos_Protobook.csv protofiles/DpiMsgLRproto.proto resources/ProtocolFilters resources/ProtocolDescriptions.csv resources/remapping resources/remapping.yaml resources/NetMonFieldNames.csv > $TMPFILE2
