...
print "\"TimeStart\" : { \"type\": \"date\", \"format\": \"yyyy/MM/dd HH:mm:ss||yyyy/MM/dd||yyyy-MM-dd'T'HH:mm:ss.SSSZZ\"},\n";
print "\"TimeUpdated\" : { \"type\": \"date\", \"format\": \"yyyy/MM/dd HH:mm:ss||yyyy/MM/dd||yyyy-MM-dd'T'HH:mm:ss.SSSZZ\"},\n";
